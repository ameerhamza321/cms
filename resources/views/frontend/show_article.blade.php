                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="item7-card-img">
                                <img src="{{ $articles->image_url }}" alt="img" class="w-100">
                                <div class="item7-card-text">
                                    <span class="badge badge-info">Jobs</span>
                                </div>
                            </div>
                            <div class="item7-card-desc d-flex mb-2 mt-3">
                                <a href="#"><i class="fa fa-calendar-o text-muted mr-2"></i>{{ $articles->date }}</a>
                                <a href="#"><i class="fa fa-user text-muted mr-2"></i>{{$articles->user->name}}</a>
                                <div class="ml-auto">
                                    <a href="#"><i class="fa fa-comment-o text-muted mr-2"></i>2 Comments</a>
                                </div>
                            </div>
                            <a href="#" class="text-dark"><h2 class="font-weight-semibold">{{ $articles->title }}</h2></a>
